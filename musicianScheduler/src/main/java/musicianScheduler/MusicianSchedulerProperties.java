...
public class MusicianSchedulerProperties {
	...
	public String toString() {
		return "MusicianSchedulerProperties [validationMessage="
				+ validationMessage + ", schedulerCoreThreadPoolSize="
				+ schedulerCoreThreadPoolSize + ", schedulerMaxThreadPoolSize="
				+ schedulerMaxThreadPoolSize + ", schedulerQueueCapacity="
